...
vstuff[3].addEventListener("ended",function(){nextpage()});
...
function nextpage(){
    window.setTimeout('window.location.replace("../Jenny_cook3/index.html")',10);
}
function messup(){
    playAudio();
    document.getElementById("f").innerHTML="oh, no! I forgot how to stuff wontons :<"
